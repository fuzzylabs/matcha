...
def test_cli_train_command_script_does_not_exist(runner: CliRunner):
    """Test that the FileNotFoundError is handled correctly when run.py does not exist when running train.
...
def test_cli_deploy_command_script_does_not_exist(runner: CliRunner):
    """Test that the FileNotFoundError is handled correctly when run.py does not exist when running deploy.
