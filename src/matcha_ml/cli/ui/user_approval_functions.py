...
def is_user_approved(verb: str, resources: List[Tuple[str, str]], stack: str) -> bool:
    ...
    Args:
        ...
        stack (str): the name of the stack being manipulated by the user

    Returns:
        bool: True if user approves, False otherwise.
    """
    summary_message = build_resource_confirmation(
        header=f"The following {stack} stack resources will be {verb}ed",
        resources=resources,
